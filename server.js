...
app.use('/api/orc/apartment', require('./routes/Apartments'));
app.use('/api/orc/children', require('./routes/Children'));
app.use('/api/orc/person', require('./routes/Person'));
app.use('/api/orc/event', require('./routes/ImageUpload'));
